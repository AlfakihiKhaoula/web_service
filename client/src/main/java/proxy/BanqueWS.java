 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://service/", wsdlLocation = "http://localhost:7070/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:7070/BanqueWS?wsdl");
